...
from mepd.elementarystep import _filter_new_structures
from mepd.nodes import nodehelpers
...
def test_filter_new_structures_does_not_collect_comparisons(monkeypatch):
    ...
    monkeypatch.setattr("mepd.elementarystep.is_identical", _fake_is_identical)
